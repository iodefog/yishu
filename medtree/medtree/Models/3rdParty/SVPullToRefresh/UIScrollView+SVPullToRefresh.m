...
//                                                lineBreakMode:self.titleLabel.lineBreakMode];
        CGSize titleSize = [self.titleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight) options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading|NSStringDrawingUsesDeviceMetrics|NSStringDrawingTruncatesLastVisibleLine attributes:@{NSFontAttributeName:self.titleLabel.font} context:nil].size;
        titleSize.width += 1;
...
//                                                      lineBreakMode:self.subtitleLabel.lineBreakMode];
        CGSize subtitleSize = [self.subtitleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.subtitleLabel.font.lineHeight) options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading|NSStringDrawingUsesDeviceMetrics|NSStringDrawingTruncatesLastVisibleLine attributes:@{NSFontAttributeName:self.subtitleLabel.font} context:nil].size;
...
//	CGContextAddRect(c, CGRectMake(5, 30, 12, 4));
    ...
    CGContextAddRect(c, CGRectMake(9, 6, 4, 4)); // currently fixed size: 22 x 48pt
    CGContextAddRect(c, CGRectMake(8, 12, 6, 4));
    CGContextAddRect(c, CGRectMake(7, 18, 8, 4));
    CGContextAddRect(c, CGRectMake(6, 24, 10, 4));
    CGContextAddRect(c, CGRectMake(4, 30, 14, 4));
