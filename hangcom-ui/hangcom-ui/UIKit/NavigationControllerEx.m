...
- (void)createUI
{
    ...
    pan = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(paningGestureReceive:)];
...
- (UIViewController *)popViewControllerAnimated:(BOOL)animated
{
    ...
    //
//    if (self.viewControllers.count <= 2 || !canDragBack) {
//        pan.enabled = NO;
//    } else {
//        pan.enabled = YES;
//    }
...
- (void)enableDragBack:(NSNumber *)tf
{
//    canDragBack = [tf boolValue];
//    pan.enabled = [tf boolValue];
}
