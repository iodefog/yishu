...
- (void)reloadHeaderTableViewDataSource 
{
    ...
    if (parent != nil && [parent respondsToSelector:@selector(loadHeader:)] == YES) {
        [parent performSelector:@selector(loadHeader:) withObject:self];
    } else if (parent != nil && [parent respondsToSelector:@selector(loadHeader)] == YES) {
...
- (void)reloadFooterTableViewDataSource 
{
    ...
    if (parent != nil && [parent respondsToSelector:@selector(loadFooter:)] == YES) {
        [parent performSelector:@selector(loadFooter:) withObject:self];
    } else if (parent != nil && [parent respondsToSelector:@selector(loadFooter)] == YES) {
